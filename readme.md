This is a simple DNN solution for basic multiclass classification tasks. It is trained on FashionMNIST dataset, and can correctly classify the objects in the dataset with around 89.3% accuracy.
